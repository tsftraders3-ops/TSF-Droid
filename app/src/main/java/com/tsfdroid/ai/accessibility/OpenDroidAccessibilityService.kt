...
class OpenDroidAccessibilityService : AccessibilityService() {
    ...
    @Inject
    lateinit var habitRoutineEngine: dagger.Lazy<com.tsfdroid.ai.core.routine.HabitRoutineEngine>
    ...
    private fun openMainActivityAction() {
        val intent = Intent(this, com.tsfdroid.ai.MainActivity::class.java).apply {
